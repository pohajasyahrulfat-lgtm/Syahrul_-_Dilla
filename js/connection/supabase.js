...
export const getInvitation = (slug) => {
    ...
    url.searchParams.set('select', 'slug,groom_name,bride_name,event_date,location,description,timezone,is_published,groom_photo_url,bride_photo_url,audio_url,cover_urls,gallery_urls,content');
